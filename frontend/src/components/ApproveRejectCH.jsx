...
const ApproveRejectCH = () => {
  ...
  const handleTable = (e) => {
    ...
    axios
      .post("http://localhost:5000/ExtraCHRequest", {
  ...
  const handleRequest = (e) => {
    ...
    axios.post("http://localhost:5000/Approve_Reject_CredHours_Request", {
      requestID,
      curr_sem: axios
...
export default ApproveRejectCH;
